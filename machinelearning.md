...
| 5 | `Notebooks/ML_05_logistic_calibration.ipynb`: [ML_05_logistic_logloss_calibration.ipynb](https://github.com/sierraporta/Intro-Machine-Learning-UnderGraduated/blob/main/Notebooks/ML_05_logistic_logloss_calibration.ipynb) y unas notas inetresantes: [LOGISTIC REGRESSION: Regression for Classification, por Erin Bugbee y Jared Wilber](https://mlu-explain.github.io/logistic-regression/) | Regresión logística | Sigmoide; log-loss; matriz de confusión; umbral por costos; calibración y Brier (si aplica). |
