...
| 4 | `Lectures/Slices`: [MACHINE_LEARNING_notes_RIDGE_LASSO.pdf](https://github.com/sierraporta/Intro-Machine-Learning-UnderGraduated/blob/main/Notas/MACHINE_LEARNING_notes_RIDGE_LASSO.pdf) `Notebooks/ML_04_linear_ridge_lasso.ipynb`: [ML_04_Ridge_Lasso_regression_classification.ipynb](https://github.com/sierraporta/Intro-Machine-Learning-UnderGraduated/blob/main/Notebooks/ML_04_Ridge_Lasso_regression_classification.ipynb) | Regresión lineal + regularización | OLS vs GD (visión); Ridge/Lasso; sesgo-varianza; selección de $\lambda$. |
| 5 | `Notebooks/ML_05_logistic_calibration.ipynb`: [ML_05_logistic_logloss_calibration.ipynb](https://github.com/sierraporta/Intro-Machine-Learning-UnderGraduated/blob/main/Notebooks/ML_05_logistic_logloss_calibration.ipynb), unas notas introductorias interesantes: [LOGISTIC REGRESSION: Regression for Classification, por Erin Bugbee y Jared Wilber](https://mlu-explain.github.io/logistic-regression/) | Regresión logística | Sigmoide; log-loss; matriz de confusión; umbral por costos; calibración y Brier (si aplica), y unas notas introductorias de mi autoria: [MACHINE_LEARNING_notes_RIDGE_LASSO.pdf](https://github.com/sierraporta/Intro-Machine-Learning-UnderGraduated/blob/main/Notas/MACHINE_LEARNING_notes_RIDGE_LASSO.pdf). |
| 6 | `Notebooks/ML_06_knn_cv_scaling.ipynb`: [ML_06_knn_cv_scaling.ipynb](https://github.com/sierraporta/Intro-Machine-Learning-UnderGraduated/blob/main/Notebooks/ML_06_knn_cv_scaling.ipynb), un ejercicio en clase (basado en las notas de pdf): [Book_Knn.xlsx](https://github.com/sierraporta/Intro-Machine-Learning-UnderGraduated/blob/main/Notas/Book_Knn.xlsx), y unas notas introductorias de mi autoria: [MACHINE_LEARNING_knn.pdf](https://github.com/sierraporta/Intro-Machine-Learning-UnderGraduated/blob/main/Notas/MACHINE_LEARNING_knn.pdf) | KNN | Distancias; necesidad de escalado; elección de \(k\); validación cruzada; sensibilidad. |
